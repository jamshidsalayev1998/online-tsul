                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="invoice-address">
                                    ...
                                    @if(App::isLocale('en'))
                                        <p>
                                            Your application for admission to the bachelor degree of Tashkent State Law University
                                    ...
                                    @if(App::isLocale('uz'))
                                        <p>
                                            Hurmatli arizachi Sizning Toshkent davlat yuridik universiteti bakalavriat qabuli uchun yo`llangan arizangiz tekshirish uchun qabul qilindi. Sizga 72 soat ichida ko`rsatilgan elektron pochta manzilingizga arizangizning qabul qilinganligi va unga unikal raqam berilganligi to`grisida yoki arizangiz qabul qilinmaganligi to`grisida axborot beriladi.
                                        </p>
                                    @endif
                                    <p>
