...
<div class="container">
    <div class="app-heading-container app-heading-bordered bottom">
        <ul class="breadcrumb">
            ...
            <li><a href="{{ route('masters.index') }}">Magistratura</a></li>
            <li class="active">O'quvchini ko'rish</li>
        </ul>
    </div>
    ...
    <div class="block padding-top-20">
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <div class="col-md-4">
                    <a href="{{route('masters.edit',['id'=>$data->id])}}" class="btn btn-default btn-icon-fixed"><span class="icon-pencil"></span> O'zgartirish</a>
                </div>
                <div class="col-md-4">
                    <a href="{{route('masters.index')}}" class="btn btn-default btn-icon-fixed "><span class="icon-list"></span> Ro'yxat</a>
                </div>
                <div class="col-md-4">
                    <form action="{{ route('masters.destroy', ['id' => $data->id]) }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('delete') }}
                        ...
                        <div class="col-lg-9">
                            <div class="row padding-10">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="margin-top-10">
                                        <span>Tug'ilgan joyi:</span>&nbsp;&nbsp;&nbsp;<strong style="color:dodgerblue"> {{ $data->student->number }}</strong>
                                    </div>
                                    @endif
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row margin-top-20 padding-10">
                                ...
                                <div class="col-md-6">
                                    <div class="margin-top-10">
                                        <span>Passport berilgan sana:</span><strong> &nbsp;&nbsp;&nbsp;{{ $data->passport_given_date }}</strong>
                                    </div>
                                    <div class="margin-top-10">
                            ...
                            <div class="row margin-top-20 padding-10">
                                ...
                                <div class="col-md-6">
                                    <div class="margin-top-10">
                                        <span>Mutaxasislik:</span><strong> &nbsp;&nbsp;&nbsp;{{ $data->getCourse() }}</strong>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="margin-top-10">
                                        <span>Ta'lim tili:</span><strong> &nbsp;&nbsp;&nbsp;{{ $data->getCourseLang() }}</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="row margin-top-20 padding-10">
                                ...
                                <div class="col-md-6">
                                    <div class="margin-top-10">
                                        <span>Chet tilini bilish:</span><strong> &nbsp;&nbsp;&nbsp;{{ $data->foreignLang() }}</strong>
                                    </div>
                                    <div class="margin-top-10">
                                        <span>Bakalavr Diplomi (pdf):</span><strong> &nbsp;&nbsp;&nbsp;
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <div class="margin-top-10">
                                        <span>Tavsiya xati (pdf):</span><strong> &nbsp;&nbsp;&nbsp;
                                            <a target="_blank" style="color:dodgerblue" href="{{ asset($data->copy_letter) }}"><i class="fa fa-file-pdf-o">&nbsp;</i>FILE</a>
                                        </strong>
                                    </div>
                                </div>
                                <div class="col-md-12 margin-top-15">
                                    Ingliz tilini bilish darajasi:<br>
                                    @if($data->lang_cert_type != null)
                                    <div class="col-md-3 padding-20">
                                        <p style="text-align: center;margin: 3px;padding: 0">{{ $data->getCerificate() }}</p>
                                        <hr style="border:1px solid black;padding: 0;margin: 0">
                                    </div>
                                    <div class="col-md-3 padding-20">
                                        <p style="text-align: center;margin: 3px;padding: 0">{{ $data->lang_cert_result }}</p>
                                        <hr style="border:1px solid black;padding: 0;margin: 0">
                                    </div>
                                    <div class="col-md-3 padding-20">
                                        <p style="text-align: center;margin: 3px;padding: 0">{{ $data->lang_cert_taken_date }}</p>
                                        <hr style="border:1px solid black;padding: 0;margin: 0">
                                    </div>
                                    <div class="col-md-3 padding-20">
                                        <p style="text-align: center;margin: 3px;padding: 0">
                                            <a target="_blank" style="color:dodgerblue" href="{{ asset($data->lang_cert_file) }}"><i class="fa fa-file-pdf-o">&nbsp;</i>FILE</a>
                                        </p>
                                        <hr style="border:1px solid black;padding: 0;margin: 0">
                                    </div>
                                    @endif
                                ...
                                <div class="col-md-12 margin-top-15">
                                     Qo'shimcha ma'lumot:<br>
                                    <div class="col-md-12 padding-20">
                                        <blockquote><i>{{ $data->aboutme }}</i></blockquote>
                                    </div>
                                </div>
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('mastersconfirm') }}" method="post" id="password_update">
                                        {{csrf_field()}}
                    ...
                    <div class="modal fade" id="modal-show" tabindex="-1" role="dialog">
                        <div class="modal-dialog modal-lg" role="document">
                            ...
                            <div class="modal-content padding-20">
                                ...
                                <form action="{{route('mastersmailto')}}" method="POST" id="message-form">
                                    {{ csrf_field() }}
                                    ...
                                    <button type="button" id="mailtouser" class="btn btn-success pull-right">Yuborish</button>
                                </form>
                            </div>
                        </div>
                    </div>
